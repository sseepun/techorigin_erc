                            ...
                            <div class="tab-contents">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="pt-1">
                                            <div class="radio-container">
                                                <input type="radio" name="radio_0" id="radio_0_0" value="0" required />
                                                <label for="radio_0_0">
                                                    ด้านความโปร่งใสและส่งเสริมการมีส่วนร่วมของประชาชน
                                                </label>
                                            </div>
                                            <div class="radio-container">
                                                <input type="radio" name="radio_0" id="radio_0_1" value="1" required />
                                                <label for="radio_0_1">
                                                    ด้านการเสริมสร้างสันติสุขและความสมานฉันท์
                                                </label>
                                            </div>
                                            <div class="radio-container">
                                                <input type="radio" name="radio_0" id="radio_0_2" value="2" required />
                                                <label for="radio_0_2">
                                ...
                                <div class="tab-content" data-tab="1">
                                    <form action="" method="POST">
                                        ...
                                        <div class="pt-1">
                                            <div class="radio-container">
                                                <input type="radio" name="radio_1" id="radio_1_0" value="0" required />
                                                <label for="radio_1_0">
                                                    ด้านความโปร่งใสและส่งเสริมการมีส่วนร่วมของประชาชน
                                                </label>
                                            </div>
                                            <div class="radio-container">
                                                <input type="radio" name="radio_1" id="radio_1_1" value="1" required />
                                                <label for="radio_1_1">
                                                    ด้านการเสริมสร้างสันติสุขและความสมานฉันท์
                                                </label>
                                            </div>
                                            <div class="radio-container">
                                                <input type="radio" name="radio_1" id="radio_1_2" value="2" required />
                                                <label for="radio_1_2">
                                                    ด้านการเสริมสร้างเครือข่าย รัฐ เอกชน และประชาสังคม
                                                </label>
                                            </div>
