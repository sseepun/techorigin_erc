...
<head>
    ...
    <style>
        ...
        .main-vdo-inside .video-container video{ width: calc(30vh * 16 / 9); height:30vh; border-radius: .625rem; border: .125rem solid #fff;}
        /* content-04 */
                ...
                <div class="grid lg-75 md-100 sm-100">
                    ...
                    <div class="content-04">
                        <div class="text-container">
                            ...
                            <div class="title">วิดิโอคลิปที่เกี่ยวข้อง</div>
                        </div>
                        <div class="grids">
                            <?php for($i=0; $i<4; $i++){?>
